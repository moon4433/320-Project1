...
public class Buffer
{
    ...
    /// <summary>
    /// this is an alias for ReadUInt8()
    /// </summary>
    ...
    public void WriteSingeBE(float val, int offset = 0)
    {
    ...
    public void WriteSingeLE(float val, int offset = 0)
    {
        byte[] parts = BitConverter.GetBytes(val);
    ...
    {
        if (bits.Length < 8) return; // dont crash
